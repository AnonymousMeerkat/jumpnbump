...
macro ( FindSDL_component _component )
  ...
  set ( SDL2${UPPERCOMPONENT}_FOUND "NO" )
  set ( SDL2_header_name SDL_${_component}.h )
  set ( SDL2_COMPONENT_NAME ${UPPERCOMPONENT} )
  ...
  if ( ${UPPERCOMPONENT} STREQUAL "GFX" )
    set ( SDL2_header_name SDL_gfxPrimitives.h )
    set ( SDL2_COMPONENT_NAME GFXPRIMITIVES )
  endif ()

  find_path ( SDL2${UPPERCOMPONENT}_INCLUDE_DIR ${SDL2_header_name}
    HINTS
  ...
  find_library ( SDL2${UPPERCOMPONENT}_LIBRARY
    NAMES SDL2_${_component}
    HINTS
    $ENV{SDL2${UPPERCOMPONENT}DIR}
    $ENV{SDL2DIR}
    PATH_SUFFIXES lib64 lib
    PATHS
    /sw
  ...
  if ( SDL2${UPPERCOMPONENT}_LIBRARY AND SDL2${UPPERCOMPONENT}_INCLUDE_DIR )
    set ( SDL2${UPPERCOMPONENT}_FOUND "YES" )
    set ( SDL2${UPPERCOMPONENT}_MAINHEADER "${SDL2${UPPERCOMPONENT}_INCLUDE_DIR}/${SDL2_header_name}" )

    find_sdl_version ( "${SDL2${UPPERCOMPONENT}_MAINHEADER}"
      "${SDL2_COMPONENT_NAME}"
      SDL2_${UPPERCOMPONENT}_MAJOR
      SDL2_${UPPERCOMPONENT}_MINOR
      SDL2_${UPPERCOMPONENT}_MICRO )

    set ( SDL2_${UPPERCOMPONENT}_LIBRARY_DIRS "" )
    foreach( my_sdl_lib ${SDL2${UPPERCOMPONENT}_LIBRARY} )
      get_filename_component(_sdl_my_lib_path "${my_sdl_lib}" PATH)
      list(APPEND SDL2_${UPPERCOMPONENT}_LIBRARY_DIRS ${_sdl_my_lib_path})
    endforeach()
    list(REMOVE_DUPLICATES SDL2_${UPPERCOMPONENT}_LIBRARY_DIRS)
  endif ()
endmacro ()

set ( SDL2_LIBRARY_DIRS "" )
foreach( my_sdl_lib ${SDL2_LIBRARY} )
  get_filename_component(_sdl_my_lib_path "${my_sdl_lib}" PATH)
  list(APPEND SDL2_LIBRARY_DIRS ${_sdl_my_lib_path})
endforeach()
...
find_sdl_version ( "${SDL2_INCLUDE_DIR}/SDL_version.h"
  ""
  SDL_MAJOR
  SDL_MINOR
  SDL_MICRO )
